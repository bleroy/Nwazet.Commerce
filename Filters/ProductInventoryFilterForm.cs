...
namespace Nwazet.Commerce.Filters {
    public class ProductInventoryFilterForm : IFormProvider {
        public Localizer T { get; set; }
        protected dynamic Shape { get; set; }
        private readonly Work<IResourceManager> _resourceManager;
        public ProductInventoryFilterForm(IShapeFactory shapeFactory, Work<IResourceManager> resourceManager) {
            Shape = shapeFactory;
        ...
        public void Describe(DescribeContext context) {
            ...
            context.Form("ProductInventoryFilterForm", form);
        }
    }
}
