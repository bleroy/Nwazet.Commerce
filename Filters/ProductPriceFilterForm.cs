...
namespace Nwazet.Commerce.Filters {
    public class ProductPriceFilterForm : IFormProvider {
        public Localizer T { get; set; }
        protected dynamic Shape { get; set; }
        private readonly Work<IResourceManager> _resourceManager;
        public ProductPriceFilterForm(IShapeFactory shapeFactory, Work<IResourceManager> resourceManager) {
            Shape = shapeFactory;
        ...
        public void Describe(DescribeContext context) {
            ...
            context.Form("ProductPriceFilterForm", form);
        }
    }
}
