...
namespace Nwazet.Commerce.Filters {
    ...
    public class ProductSkuFilterForm : IFormProvider {
        public Localizer T { get; set; }
        protected dynamic Shape { get; set; }

        public ProductSkuFilterForm(IShapeFactory shapeFactory) {
            Shape = shapeFactory;
        ...
        public void Describe(DescribeContext context) {
            Func<IShapeFactory, dynamic> form =
                shape => {
                    var f = Shape.Form(
                        Id: "ProductSkuFilterForm",
                        _ProductFilterForm: Shape.TextBox(
                            Id: "Value", Name: "Value",
                            Title: T("The Product Sku"),
            ...
            context.Form("ProductSkuFilterForm", form);
        }
    }
}